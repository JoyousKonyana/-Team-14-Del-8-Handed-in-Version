...
export class EquipmentComponent implements OnInit {
  ...
  addEquipment() {
    ...
    this.model3.EquipmentBrandId = this.registerEquipmentForm.get('EquipmentBrandId')?.value;
   
    this.model3.EquipmentSerialNumber = this.registerEquipmentForm.get('EquipmentSerialNumber')?.value;
